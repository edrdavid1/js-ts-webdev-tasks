...
git remote add upstream https://github.com/School-of-Digital-Competencies/js-ts-webdev-tasks.git
```

#### Visual Studio Code

In Source Control menu click on three dots -> Remote -> Add remote -> Paste `https://github.com/School-of-Digital-Competencies/js-ts-webdev-tasks.git` -> Enter `upstream`
